    ...
    return (
      <Container fluid className="main-content-container px-4">
        ...
        <p>
          ...
          Доставка блюд осуществляется от получаса до 1 часа с момента заказа на сайте.<br/>
          Стоимость доставки от <b>50</b> грн, при заказе от <b>400</b> грн <b>доставка бесплатная</b>.
        </p>
        <Snackbar
          anchorOrigin={{
            vertical: 'top',
